...
import cn.edu.guet.weapp_SpringBoot.service.impl.SysLogServiceImpl;
import cn.edu.guet.weapp_SpringBoot.util.HttpUtils;
import cn.edu.guet.weapp_SpringBoot.util.IPUtils;
...
public class SysLogAspect {
    ...
    @Pointcut("execution(* cn.edu.guet.weapp_SpringBoot.service.*.*(..))")

...
import cn.edu.guet.weapp_SpringBoot.util.StringUtils;
...
public class DaoAspect {
    ...
    @Pointcut("execution(* cn.edu.guet.weapp_SpringBoot.*.mapper.*.update*(..))")
    public void daoUpdate() {
    }

    @Pointcut("execution(* cn.edu.guet.weapp_SpringBoot.*.mapper.*.insert*(..))")
